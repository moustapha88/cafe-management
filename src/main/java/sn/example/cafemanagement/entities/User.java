...
@NamedQuery(name = "User.findByUsername", query = "select new sn.example.cafemanagement.wrapper.UserWrapper(u.id,u.username,u.email,u.contactNumber,u.status) from User u where u.username=username")
